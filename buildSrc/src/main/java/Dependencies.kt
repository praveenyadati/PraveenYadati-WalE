...
object ThirdPartyLibraries {
    private object Versions {
        ...
        const val loggerVersion = "4.2.0"
        const val picasoVersion = "2.71828"
    }
    ...
    const val logger = "com.squareup.okhttp3:logging-interceptor:${Versions.loggerVersion}"
    const val picasso = "com.squareup.picasso:picasso:${Versions.picasoVersion}"
